...
async def inline_handler(event):
    ...
    if not query:
        results = builder.article(
            title="Hello, I'm Rashmika AI Bot! Touch for help!",
...
async def explore(event):
    ...
    oof_stark = f"""**Inline bot service powered by @Rashmika_AIbot**
...
**Example :** `@{tbot_username} google ironmangujju github`
**- Deezer Search!**
