...
async def shazamm(client, message):
    ...
    await kek.edit("**Searching For This Song In My DataBase.**")
    ...
    if xo.get("success") is False:
        await kek.edit("`Song Not Found in my Database. Please Try Again.`")
...
<b>Song Name : </b>{title}
<b>Song By : </b>{by}
<u><b>Identified Using @Rashmika_AIbot</b></u>
"""
