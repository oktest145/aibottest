...
async def get_start_func(message, strings, edit=False):
    ...
    buttons.add(
        InlineKeyboardButton(strings["btn_channel"], url="https://t.me/Ironman_cloud"),
        InlineKeyboardButton("Support Grup", url="https://t.me/ironman_cloud_support"),
    )
    buttons.add(
        InlineKeyboardButton(
            "Add Rashmika to your group",
            url=f"https://telegram.me/Rashmika_AIbot?startgroup=true",
        )
    )
...
async def help_cmd_g(message, strings):
    ...
    button = InlineKeyboardMarkup().add(
        InlineKeyboardButton(text=text, url="https://t.me/Rashmika_AIbot?start")
    )
    await message.reply(strings["help_header"], reply_markup=button)
